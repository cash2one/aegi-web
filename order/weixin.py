...
# 20170322
# for wechat pay
# source: https://github.com/zwczou/weixin-python/blob/dev/weixin/pay.py
...
from weixinBase import Map, WeixinError
try:
...
class WeixinPay(object):
    def __init__(self, appid, mch_id, mch_key, spbill_create_ip, notify_url):
        self.appid = appid
        self.mch_id = mch_id
    ...
    def unified_order(self, **data):
        ...
        appid, mchid, nonce_str自动填写
        spbill_create_ip需要主动传入此参数
        """
